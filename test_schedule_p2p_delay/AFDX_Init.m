...
% 每个交换机能处理的vid -> 下一跳
swA_map = containers.Map({1,2,3,4},{[3 1],[3 1],[3 1],[3 1]});
% swB_map = containers.Map({3,4},{[3 1],[3 1]});
...
vid_vec = [3 4];
deadline_vec = [0.12 0.23];
Msg_kB = struct('vid',{},'bag',{},'pri',{},'lmax',{},'jit',{},'deadline',{},'sort',{},'recvtime',{});
[~, c] = size(vid_vec);
for j = 1:c
    msg.vid = vid_vec(1, j);
    msg.bag = BAG_vec(1, j);
...
global v3_delay_array;
global v4_delay_array;

v1_delay_array=struct('delay',{},'curTime',{},'from',{},'destination',{});
v2_delay_array=struct('delay',{},'curTime',{},'from',{},'destination',{});
v3_delay_array=struct('delay',{},'curTime',{},'from',{},'destination',{});
v4_delay_array=struct('delay',{},'curTime',{},'from',{},'destination',{});
...
%----------------为每个flow设置BAG----------------
Msg_kA(1).bag=0.004; %v1
Msg_kA(2).bag=0.002; %v2

Msg_kB(1).bag=0.004; %v1
Msg_kB(2).bag=0.002; %v2

%----------------为每个flow设置Lmax----------------
Msg_kA(1).lmax = 1024*8; %v1
Msg_kA(2).lmax = 128*8; %v2

Msg_kB(1).lmax = 1024*8; %v3
Msg_kB(2).lmax = 128*8; %v4
